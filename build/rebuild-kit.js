...
let dec = exec(`npx tsc --project ./tsconfig-declaration.json --outDir ${kitPath()}`)
...
let downloads = Promise.all([
  exec('node ./run/terminal.js ./cli/download-md.js', options),
  exec('node ./run/terminal.js ./hot/download-hot.js', options),
])
