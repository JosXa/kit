declare module '@johnlindquist/kit' {
  ...
  export namespace editor {
     ...
     */
    export function colorizeElement(domNode: any, options: IColorizerElementOptions): Promise<void>
    ...
    type ComputedEditorOptionValue<T extends IEditorOption<any, any>> = T extends IEditorOption<any, infer R>
      ? R
      : never
  ...
  export interface Select {
    <T = any[]>(placeholderOrConfig?: string | PromptConfig, choices: Choices<T>, actions?: Action[]): Promise<T>
  }
  ...
  export interface Store {
    (key: string, initialData?: any): Promise<InstanceType<typeof import('keyv')>>
  }
  ...
  export interface OnTab {
    (name: string, fn: (input?: string) => void | Promise<void>): void
  }
  ...
  export interface KitModuleLoader {
    (packageName: string, ...moduleArgs: string[]): Promise<any>
  }
  export interface Edit {
    (file: string, dir?: string, line?: string | number, col?: string | number): Promise<void>
  }

  export interface Browse {
    (url: string): ReturnType<typeof import('@johnlindquist/open')>
  }
  ...
  export interface Highlight {
    (markdown: string, containerClass?: string, injectStyles?: string): Promise<string>
  }
  ...
  export interface CreateGist {
    (content: string, options?: GistOptions): Promise<RestEndpointMethodTypes['gists']['create']['response']['data']>
  }
  ...
  export type Find = {
    (placeholderOrConfig?: string | PromptConfig, options?: FileSearchOptions): Promise<string>
  }
  ...
  interface FileSearch {
    (name: string, fileSearchOptions?: FileSearchOptions): Promise<string[]>
  }
  ...
  interface GetTabs {
    (browser?: Browser): Promise<{ url: string; title: string }[]>
  }
  ...
  interface ScrapeAttribute {
    (url: string, selector: string, attribute: string, options?: ScrapeOptions): Promise<string | null>
  }
  ...
  interface GetScreenshotFromWebpage {
    (url: string, options?: ScreenshotFromWebpageOptions): Promise<Buffer>
  }
  ...
  interface GetWebpageAsPdf {
    (url: string, options?: WebpageAsPdfOptions): Promise<Buffer>
  }
  ...
  interface GetWindowPosition {
    (process: string, title: string, x: number, y: number): Promise<string>
  }
  ...
  interface SetWindowSizeByIndex {
    (process: string, index: number, x: number, y: number): Promise<string>
  }
  interface SetWindowBoundsByIndex {
    (process: string, index: number, x: number, y: number, width: number, height: number): Promise<string>
  }
  ...
  interface TileWindow {
    (app: string, leftOrRight: 'left' | 'right'): Promise<string>
  }
