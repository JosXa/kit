...
import { kitMode, returnOrEnter, run } from '../core/utils.js'
...
let newOptions: Choice<keyof CLI | keyof Main>[] = [
  ...
  },
  {
    ...
    description: 'The Tips tab has many helpful snippets to choose from',
    value: 'tips',
  },
  {
...
let previewChoices: Choice[] = await addPreview(newOptions, 'new')
...
} else if (newOptions.find((script) => script.value === cliScript)) {
