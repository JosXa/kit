import type { format, formatDistanceToNow } from '@johnlindquist/kit-internal/date-fns'
...
// biome-ignore lint/style/useShorthandArrayType: https://github.com/biomejs/biome/issues/3247
...
export type Store = (key: string, initialData?: any) => Promise<InstanceType<typeof import('keyv')>>
...
export interface KitApi {
  ...
  onTabs: {
    name: string
    fn: (input?: string) => undefined | Promise<any>
  }[]
  onTabIndex: number
