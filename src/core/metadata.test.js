...
/** @type {import("./utils")} */
let { getMetadata, parseMetadata, postprocessMetadata, stripMetadata } = await import(kitPath('core', 'utils.js'))

/** @type {import("./enum.js")} */
let { ProcessType, UI } = await import(kitPath('core', 'enum.js'))
