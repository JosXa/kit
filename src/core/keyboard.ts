...
type KeyCodes = {
  [key in KeyEnum]?: number
}
export let keyCodes: KeyCodes = {
  [KeyEnum.Enter]: 13,
  [KeyEnum.ArrowLeft]: 37,
  [KeyEnum.ArrowUp]: 38,
  [KeyEnum.ArrowRight]: 39,
  [KeyEnum.ArrowDown]: 40,
  [KeyEnum.Escape]: 27,
  [KeyEnum.Space]: 32,
  [KeyEnum.Backspace]: 8,
  [KeyEnum.Tab]: 9,
  ...
  [KeyEnum.CapsLock]: 20,
  [KeyEnum.NumLock]: 144,
  [KeyEnum.ScrollLock]: 145,
  [KeyEnum.PrintScreen]: 44,
  [KeyEnum.Pause]: 19,
  [KeyEnum.Key_0]: 48,
  [KeyEnum.Key_1]: 49,
  [KeyEnum.Key_2]: 50,
...
export let keyCodeFromKey = (key: KeyEnum) => {
  return Object.entries(keyCodes).find(([keyName]) => keyName.toLowerCase() === key.toLowerCase())?.[1] || -1
}
