...
try {
  ...
  await copyIfNotExists(kitPath('templates', 'config', 'tsconfig.json'), kenvPath('tsconfig.json'))

  await copyIfNotExists(kitPath('templates', 'scripts', 'default.js'), kenvPath('templates', 'default.js'))

  await copyIfNotExists(kitPath('templates', 'scripts', 'default.ts'), kenvPath('templates', 'default.ts'))
