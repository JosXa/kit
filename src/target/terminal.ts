...
import { adjustPackageName, assignPropsTo, debounce, isString, isUndefined } from '../core/utils.js'
...
type Enquirer = typeof import('@johnlindquist/kit-internal/enquirer').enquirer
...
global.arg = async (messageOrConfig, choices) => {
...
global.edit = async (filePath) => {
  ...
  } else if (global?.env?.KIT_EDITOR === 'kit') {
