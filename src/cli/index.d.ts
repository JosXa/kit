...
export interface CLI {
  'add-kenv-to-profile': Promise<typeof import('./add-kenv-to-profile')>
  'add-kit-to-profile': Promise<typeof import('./add-kenv-to-profile')>
  'browse-examples': Promise<typeof import('./browse-examples')>
  'refresh-scripts-db': Promise<typeof import('./refresh-scripts-db')>
  'change-editor': Promise<typeof import('./change-editor')>
  'change-main-shortcut': Promise<typeof import('./change-main-shortcut')>
  'change-shortcut': Promise<typeof import('./change-shortcut')>
  'create-all-bins': Promise<typeof import('./create-all-bins')>
  'create-all-bins-no-trash': Promise<typeof import('./create-all-bins-no-trash')>
  'create-bin': Promise<typeof import('./create-bin')>
  'edit-file': Promise<typeof import('./edit-file')>
  'editor-history': Promise<typeof import('./editor-history')>
  ...
  'kenv-change-dir': Promise<typeof import('./kenv-change-dir')>
  'manage-npm': Promise<typeof import('./manage-npm')>
  'more-info': Promise<typeof import('./more-info')>
  'new-from-clipboard': Promise<typeof import('./new-from-clipboard')>
  'new-from-template': Promise<typeof import('./new-from-template')>
  'new-from-url': Promise<typeof import('./new-from-url')>
  'open-at-login': Promise<typeof import('./open-at-login')>
  'open-command-log': Promise<typeof import('./open-command-log')>
  'open-kit': Promise<typeof import('./open-kit')>
  'kit-clear-prompt': Promise<typeof import('./kit-clear-prompt')>
  ...
  'remove-env-var': Promise<typeof import('./remove-env-var')>
  ...
  'share-script-as-discussion': Promise<typeof import('./share-script-as-discussion')>
  'share-script-as-link': Promise<typeof import('./share-script-as-link')>
  'share-script-as-markdown': Promise<typeof import('./share-script-as-markdown')>

  'share-script-as-kit-link': Promise<typeof import('./share-script-as-kit-link')>
  ...
  'kenv-switch': Promise<typeof import('./kenv-switch')>
  'toggle-background': Promise<typeof import('./toggle-background')>
  tutorial: Promise<typeof import('./tutorial')>
  uninstall: Promise<typeof import('./uninstall')>
  update: Promise<typeof import('./update')>
  'update-kit-package': Promise<typeof import('./update-kit-package')>

  'sync-path': Promise<typeof import('./sync-path')>
  'sync-path-instructions': Promise<typeof import('./sync-path-instructions')>
  'toggle-tray': Promise<typeof import('./toggle-tray')>
  'toggle-auto-update': Promise<typeof import('./toggle-auto-update')>
}

type CliModuleLoader = (packageName: keyof CLI, ...moduleArgs: string[]) => Promise<any>
