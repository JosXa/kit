...
import { checkIfCommandExists, extensionRegex, trashScriptBin } from '../core/utils.js'
...
let script: Script = await selectScript('Which script do you want to rename?')
...
let newFilePath = path.resolve(path.dirname(filePath), lenientCommand + scriptExtension)
